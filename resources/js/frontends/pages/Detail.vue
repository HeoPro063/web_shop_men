        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-md-6">
            <div class="detail__product_description ps-3">
              ...
              <div class="mockup__buying d-flex pt-5">
                <button class="btn btn-danger text-center w-25">
                  <i class="fa fa-shopping-cart"></i>
                  Đăng ký mua
                </button>
                <button class="btn text-danger text-center">
                ...
                <div class="carousel-item active">
                  <div class="col-md-3">
                    <div class="card border-0">
                      <div class="product-item pt-2 pe-2 ms-2 me-2 mt-2">
                        ...
                        <div class="product__title">
                          <a
                            href="#"
                            class="link-title text-decoration-none text-dark"
                          >Áo Sơ Mi Oxford Tay Ngắn ASM017 Màu Xanh</a>
                        </div>
