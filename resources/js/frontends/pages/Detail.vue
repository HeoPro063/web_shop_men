            ...
            <div class="row">
                <div class="col-sm-6 col-md-6">
                    <div class="detail__photo">
                        ...
                        <div class="description_photo p-3 d-flex justify-content-center">
                            <div class="description_photos-img" v-for="(item, index) in dataDetail.data_images" :key="index">
                ...
                <div class="col-sm-6 col-md-6">
                    <div class="detail__product_description ps-3">
                        <h2 class="product_description__title" style="text-transform: uppercase;">{{dataDetail.name}}</h2>
                        <div class="evaluate">
                        ...
                        <div class="detail__product__price d-flex pt-3">
                            ...
                            <div v-if="dataDetail.status_promotion === 0" class="product__price__number ps-2">{{formatPrice(dataDetail.price)}}</div>
                            <div v-else class="product__price__number ps-2">
                                {{formatPrice(dataDetail.price_promotion)}}
                                <span class="price_promotion">{{formatPrice(dataDetail.price)}}</span>
                        ...
                        <div class="detail__product__color pt-3 d-flex">
                            ...
                            <div class="detail__product__color__photo ps-5 d-flex">
                                <button v-for="(item, index) in dataDetail.data_colors" :key="index" class="btn--choose me-3" @click="chooseColor(item.id)" :class="{'text-danger':item.id === dataAddCart.color_id}">{{item.name}}</button>
                            </div>
                        </div>
                        <div class="mockup__oder pb-2 pt-4">
                            <ul class="nav-node p-0 m-0">
                                <li class="list-unstyled me-4 d-flex">
                                    Size*
                                    <div class="detail__product__color__photo ps-5 d-flex">
                                        <button v-for="(item, index) in dataDetail.data_sizes" :key="index" class="btn--choose--size me-3" @click="chooseSize(item.id)" :class="{'text-danger':item.id === dataAddCart.size_id}">{{item.name}}</button>
                                    </div>
                                </li>
                                <li class="list-unstyled mt-3 d-flex">
                                    Số lượng *
                                    <input type="number" name="number" min="1" v-model="dataAddCart.quantity" :max="dataDetail.quantity" />
                                    <span v-if="dataAddCart.quantity > dataDetail.quantity" class="text-danger">Sản phẩm hiện tại không đủ</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div v-else class="mockup__buying d-flex pt-5">
                            <button @click="addSubmitCart" :disabled="dataAddCart.color_id === null || dataAddCart.size_id === null" class="btn text-danger text-center">
                        ...
                        <div class="detail w-100">
                            <a href="#" class="detail-link d-block text-center text-decoration-none text-white w-100">
                                xem
                                chi tiết sản
                                phẩm
                            </a>
                                                ...
                                                <div class="card">
                                                    <div class="product-item pt-2 pe-2 me-2 mt-2">
                                                        <div class="product__img position-relative">
                                                            <img src="frontend/images/quan-tay-phoi-day-soc-qt023-mau-den-15964.png" class="product" alt />
                                                            <span class="product__cart position-absolute">
                                                                <i class="fa fa-shopping-cart"></i>
                                                            </span>
                                                        </div>
                                                        <div class="product__img__item mt-1 mb-1">
                                                            <img src="frontend/images/quan-tay-phoi-day-soc-qt023-mau-den-15964.png" class="product-items" alt />
                                                        </div>
        ...
        <div class="detail__footer mt-3">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link border active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Đánh giá</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link border" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">Bình luận</button>
                </li>
            </ul>
