        ...
        <div class="col-12 mt-3">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Edit Size</h5>
                </div>
             </div>
            ...
            {{ csrf_field() }}
                <div class="card-body">
                    ...
                    <input type="text"  class="form-control w-50 @if($errors->has('name')) is-invalid @endif" value="{{old('name', $size->name)}}" name="name" placeholder="Name size">
